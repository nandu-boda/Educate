...
const About = ({setPlayState}) => {
    return(
        <div className="about">
            ...
            <img src="../../public/about1.png" alt="" className="about-img" />
            <img src="../../public/about2.png" alt="" className="about-icon" onClick={() =>
                {setPlayState(true)}} />
            </div>
            ...
            journey with our university's comprehensive
             education programs. Our cutting-edge curriculum
              is designed to empower students with the knowledge,
               skills, and experiences needed to excel in the dynamic
                field of education.
